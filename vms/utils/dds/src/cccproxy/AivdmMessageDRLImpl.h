#ifndef CCCPROXY_AIVDMMESSAGE_DRL_IMPL_H
#define CCCPROXY_AIVDMMESSAGE_DRL_IMPL_H
...
class AivdmMessageDataReaderListenerImpl
 ...
 public:
  AivdmMessageDataReaderListenerImpl(std::string ccc_snd_addr,
                                     std::string ccc_snd_port);
  ~AivdmMessageDataReaderListenerImpl() = default;
